...
persons = [
    ...
    (2, "Samantha Kodiyella", "samantha.k@example.lk", "011-5551001", "Faculty", "1980-05-22",
     "456 Nagarika Mawatha, Kegalle"),
    (3, "Dinushi Jayasekara", "dinushi.j@example.lk", "011-5551002", "Student", "2001-07-30",
     "789 Pine Mawatha, Galle"),
    (4, "Sunil Wickramasinghe", "sunil.v@example.lk", "011-5551003", "Admin", "1980-05-22",
     "678 Avi Nivasa Mawatha, Maharagama"),
    (5, "Chamara Fernando", "chamara.p@example.lk", "011-5551004", "Faculty", "1975-12-10",
     "321 Oak Mawatha, Nuwara Eliya"),
    (6, "Ashoka Navaratne", "ashoka.n@example.lk", "011-5551005", "Faculty", "1978-03-14",
     "654 Maple Mawatha, Kadugoda")
]
